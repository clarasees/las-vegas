...
L.marker([36.129304, -115.165806], {icon: phillipsIcon}).addTo(map).bindPopup("Welcome to Las Vegas :-)");

L.marker([36.087078, -115.172392], {icon: atlasIcon}).addTo(map).bindPopup("Welcome to Las Vegas :-)");

L.marker([36.115299, -115.167437], {icon: soldierIcon}).addTo(map).bindPopup("Welcome to Las Vegas :-)");
